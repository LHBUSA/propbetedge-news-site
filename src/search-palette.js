...
function buildStaticRecords() {
  const core = [
    ...
    { type: 'tool', eyebrow: 'FREE PICKS', title: 'Free Picks & Model Edges', subtitle: 'Live MLB, NFL, UFC, WNBA and NHL model samples with market context', href: '/odds', keywords: ['odds', 'edges', 'picks', 'mlb', 'nfl', 'ufc', 'model'] },
