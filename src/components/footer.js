    ...
    <footer class="footer">
      <div class="container">
        ...
        <div class="footer-social-bar">
          ...
          <a href="${PROPBET_LINKS.twitter}" class="footer-social-link" target="_blank" rel="noopener noreferrer" aria-label="Follow PropBetEdge on X (@PROPBETEDGE)" title="Follow PropBetEdge on X">
