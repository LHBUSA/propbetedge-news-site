 ...
 * Editorial footer aligned to the PropBetEdge sports network funnel.
 */
      ...
      <div class="container">
        <div class="footer-grid">
          ...
          <div class="footer-col">
            ...
            <a href="${PROPBET_LINKS.picks_ufc}" target="_blank" rel="noopener">UFC Fight Intelligence <span class="footer-badge">Live</span></a>
          ...
          <div class="footer-col">
            ...
            <a href="${PROPBET_LINKS.news_ufc}" target="_blank" rel="noopener">UFC News</a>
