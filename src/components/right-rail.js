...
const RAIL_CTAS = {
  ...
  nba: {
    ...
    sub: 'Continue into live basketball research, player context and the connected NBA intelligence product.',
    href: 'https://nba.propbetedge.ai',
    label: 'Open NBA Intelligence →',
  },
  nhl: {
    eyebrow: '🏒 PROPBETEDGE NHL · LIVE',
    title: 'Take this story into NHL Intelligence.',
    sub: 'Continue into Ice Board, PBE Cast, PBE Picks, player research and documented fight intelligence.',
    href: 'https://nhl.propbetedge.ai',
    label: 'Open NHL Intelligence →',
  },
  network: {
    eyebrow: '⚡ FREE PICKS · PUBLIC PROOF',
    title: 'Every public call stays on the board.',
    sub: 'See today’s free picks, live grading and the immutable public track record.',
    href: '/odds',
    label: 'Open Free Picks →',
  },
}
